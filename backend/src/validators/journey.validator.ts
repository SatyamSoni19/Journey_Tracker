...
export const updateJourneySchema = z.object({
  ...
  body: z
    .object({
      ...
      googlePlaceName: z.string().nullish(),
    })
    .refine(
      (data) => {
...
export type CreateJourneySchemaType = z.infer<typeof createJourneySchema>["body"];
export type UpdateJourneySchemaType = z.infer<typeof updateJourneySchema>["body"];
