...
// --- Categories ---
export async function createExpenseCategory(journeyId, name, color) {
    return prisma.expenseCategory.create({
        data: { journeyId, name, color },
    });
}
export async function findExpenseCategories(journeyId) {
    return prisma.expenseCategory.findMany({
        where: { journeyId },
        orderBy: { createdAt: "asc" },
    });
}
export async function ensureDefaultCategories(journeyId) {
...
// --- Members ---
export async function createBudgetMember(journeyId, data) {
...
export async function findBudgetMembersByJourney(journeyId) {
    return prisma.budgetMember.findMany({
        where: { journeyId },
        orderBy: { createdAt: "asc" },
    });
}
export async function findBudgetMemberById(id) {
    return prisma.budgetMember.findUnique({
        where: { id },
    });
}
export async function deleteBudgetMember(id) {
    return prisma.budgetMember.delete({
        where: { id },
    });
}
// --- Expenses ---
export async function createExpense(journeyId, data) {
...
export async function findExpensesByJourney(journeyId) {
