...
import { createUser, findUserByEmail, findUserById, toSafeUser, } from "../repositories/user.repository.js";
import { createRefreshToken, findRefreshTokenByHash, revokeRefreshToken, revokeAllUserRefreshTokens, } from "../repositories/refreshToken.repository.js";
...
export async function logoutUser(incomingRefreshToken) {
